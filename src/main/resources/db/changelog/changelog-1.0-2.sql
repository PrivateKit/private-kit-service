DROP TABLE if exists survey_item_responses;
DROP TABLE if exists survey_responses;
DROP TABLE if exists question_conditions;
DROP TABLE if exists questions;
DROP TABLE if exists survey_screen_types;
DROP TABLE if exists screen_types;
DROP TABLE if exists survey_option_values;
DROP TABLE if exists survey_options;
DROP TABLE if exists survey_option_groups;
